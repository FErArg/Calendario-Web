...
("Domingo", "Lunes", "Martes", "Miercoles", "Jueves", "Vienes", "Sabado", "Domingo");
...
Calendar._TT["PREV_YEAR"] = "Prev. Year (Click para Menu)";
Calendar._TT["PREV_MONTH"] = "Prev. Month (Click para Menu)";
Calendar._TT["GO_TODAY"] = "Hoy";
Calendar._TT["NEXT_MONTH"] = "Prox. Mes (Click para Menu)";
Calendar._TT["NEXT_YEAR"] = "Prox. Año (Click para Menu)";
...
Calendar._TT["DAY_FIRST"] = "Mostrar primero  %ss";
 ...
 * Read the entire license text here: http://www.gnu.org/licenses/lgpl.html
 *
 *  Modified By SerInformaticos.es
 * 
 * info@sernformaticos.es
