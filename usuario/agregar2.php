...
<body>
	...
	extract($_POST);
	$fecha = $ano. "-". $mes. "-". $dia;
	mysql_query("insert into avisos (aviso, fecha, usuario_id) 
		values ('$aviso','$fecha','$id_usuario')");
	?>
<div class="cabecera">
...
<table class="listing" cellpadding="0" cellspacing="0" border="1">
	...
	<?php
	$query0 = " SELECT usuario_id, id, aviso, fecha FROM avisos WHERE usuario_id = '$id_usuario' ORDER BY fecha DESC ";
